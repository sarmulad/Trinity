...
const summaryCards: CardConfig[] = [
  {
    ...
    value: "100 BBLs",
    icon: <Droplet className="h-4 w-4 text-black/30 dark:text-white/40 lg:h-5 lg:w-5" />,
    bgColor: "bg-black/[0.06] dark:bg-white/[0.07]",
  },
  {
    title: "Gas Volume",
    value: "250 MCF",
    icon: <Flame className="h-4 w-4 text-black/30 dark:text-white/40 lg:h-5 lg:w-5" />,
    bgColor: "bg-black/[0.06] dark:bg-white/[0.07]",
  },
  {
    title: "Oil Stock",
    value: "1000 BBLs",
    icon: <BarChart3 className="h-4 w-4 text-black/30 dark:text-white/40 lg:h-5 lg:w-5" />,
    bgColor: "bg-black/[0.06] dark:bg-white/[0.07]",
  },
  {
    title: "Oil Sales",
    value: "180 BBLs",
    icon: <TrendingUp className="h-4 w-4 text-black/30 dark:text-white/40 lg:h-5 lg:w-5" />,
    bgColor: "bg-black/[0.06] dark:bg-white/[0.07]",
  },
  {
    title: "Gas Sold",
    value: "$345",
    icon: <DollarSign className="h-4 w-4 text-black/30 dark:text-white/40 lg:h-5 lg:w-5" />,
    bgColor: "bg-black/[0.06] dark:bg-white/[0.07]",
