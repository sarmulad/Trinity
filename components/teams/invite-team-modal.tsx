...
export function InviteTeamModal({
  ...
  const inputClass =
    "w-full rounded-lg border border-white/10 bg-[#252930] px-3 py-2.5 text-sm text-white placeholder:text-white/25 focus:border-[#34C759]/50 focus:outline-none";

  const selectClass =
    "w-full rounded-lg border border-white/10 bg-[#252930] px-3 py-2.5 text-sm text-white/50 focus:border-[#34C759]/50 focus:outline-none appearance-none cursor-pointer";
  ...
  const Label = ({
    ...
    <label className="flex items-center gap-1.5 text-xs text-white/60 mb-1.5">
      ...
      {req && <span className="ml-auto text-xs text-white/40">req.</span>}
    </label>
  );
