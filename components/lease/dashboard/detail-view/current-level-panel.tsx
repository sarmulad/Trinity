  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="rounded-xl border border-black/10 bg-black/[0.03] p-3 flex items-center gap-3 dark:border-white/10 dark:bg-[#1a1d23]">
          <div className="h-8 w-8 rounded-lg bg-amber-500/20 flex items-center justify-center text-amber-400 text-base shrink-0">
            🛢
          </div>
          <div>
            <p className="text-[10px] text-black/40 leading-none mb-0.5 dark:text-white/40">
              Oil
            </p>
